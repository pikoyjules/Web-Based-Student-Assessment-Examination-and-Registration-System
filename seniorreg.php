...
$trn_date = date("Y-m-d H:i:s");
        ...
        $query = "INSERT into `seniorhigh` (lastname, givenname, middlename, gender, citizenship, dateofbirth, zipcode, telno, fathersname, mothersname, guardiansname, currentschool, fatelno, motelno, guatelno, payment, academicyear,email,facebook, streetno ,brgy, program,trn_date) VALUES ('$lastname', '$givenname', '$middlename', '$gender', '$citizenship', '$dateofbirth', '$zipcode','$telno', '$fathersname', '$mothersname', '$guardiansname', '$currentschool', '$fatelno', '$motelno', '$guatelno', '$payment','$academicyear', '$email', '$facebook','$streetno', '$brgy','program', '$trn_date')";
...
<div class="form_div">
 <form action="" class="register">
            ...
            <fieldset class="row7">
                <legend>Program Tracks</legend>
                <p>
                     
                    <input type="radio" name="program" value="GAS" required/>
                    <label class="gender">GAS</label>
                 
                    <input type="radio" name="program" value="ABM" required/>
                    <label class="gender">ABM</label>
                   
                    <input type="radio" name="program" value="HUMMS" required/>
                    <label class="gender">HUMSS</label>
